  ...
  return (
    <div className='rounded-lg md:w-full w-[500px] h-[100vh]'>
      ...
      >
        ...
        {selectedRow && (
          <>
            <div className='flex flex-wrap mt-6 gap-6 my-10'>
              ...
              <div className='flex flex-col justify-center items-center text-sm'>
                ...
                <p className='font-semibold'>90.1%</p>
              </div>
              <div className='flex flex-col justify-center items-center text-sm'>
                <h4 className='font-bold'>GNN</h4>
                <p className='font-semibold'>88.8%</p>
              </div>
              <div className='flex flex-col justify-center items-center text-sm'>
                <h4 className='font-bold'>Randome Forest</h4>
                <p className='font-semibold'>70.3%</p>
              </div>
              <div className='flex flex-col justify-center items-center text-sm'>
